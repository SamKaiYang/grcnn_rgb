...
class RealSenseCamera:
    ...
    def connect(self):
        ...
        # print("self.scale ", self.scale, type(self.scale))
    def get_image_bundle(self):
        ...
        # print("depth_image ", depth_image.shape, type(depth_image))
        depth_image *= self.scale
        # print("depth_image 1", depth_image.shape, type(depth_image))
...
if __name__ == '__main__':
    cam = RealSenseCamera(device_id=941322072935)
    cam.connect()
    while True:
